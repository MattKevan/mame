...
void sdl_window_info::update_cursor_state()
{
	...
	if (!(machine().debug_flags & DEBUG_FLAG_OSD_ENABLED))
	{
		...
		if (strncmp(machine().system().name, "datarover", 9) == 0)
		{
			...
			if (!s_stylus_cursor)
			{
				static Uint8 const s_data[] = { 0x00, 0x00, 0x00, 0x00, 0x07, 0xe0, 0x1c, 0x38, 0x10, 0x08, 0x30, 0x0c, 0x20, 0x04, 0x20, 0x04, 0x20, 0x04, 0x20, 0x04, 0x30, 0x0c, 0x10, 0x08, 0x1c, 0x38, 0x07, 0xe0, 0x00, 0x00, 0x00, 0x00 };
				static Uint8 const s_mask[] = { 0x00, 0x00, 0x00, 0x00, 0x07, 0xe0, 0x1c, 0x38, 0x10, 0x08, 0x30, 0x0c, 0x20, 0x04, 0x20, 0x04, 0x20, 0x04, 0x20, 0x04, 0x30, 0x0c, 0x10, 0x08, 0x1c, 0x38, 0x07, 0xe0, 0x00, 0x00, 0x00, 0x00 };
